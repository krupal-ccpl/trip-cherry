...
export default function AddBookingModal({
  ...
  const ticketTypes = ["One Way", "Round Trip", "Multi City"];
  ...
  const handleNumberOfTravellersChange = (value: string) => {
    ...
    setTravellers((prev) => {
      ...
      if (validCount > current.length) {
        // Add new travellers
        const newTravellers = Array(validCount - current.length)
          .fill(null)
          .map(() => ({
            name: "",
            age: "",
  ...
  const validateForm = () => {
    ...
    numericFields.forEach((field) => {
      const value = parseFloat(
        newBooking[field as keyof typeof newBooking] as string
      );
      if (
        newBooking[field as keyof typeof newBooking] &&
        (isNaN(value) || value < 0)
      ) {
  ...
  const handleSubmit = () => {
    ...
    if (newBooking.bookingType === "flight") {
      ...
      booking.arrivalDate = newBooking.arrivalDate
        ? formatDateToDisplay(newBooking.arrivalDate)
        : "";
      ...
      booking.ancillary =
        (parseFloat(newBooking.seatCharges) || 0) +
  ...
  const resetForm = () => {
    ...
    setShowQuotedDetailedCharges(false);
  };
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-700">
              <th className="px-3 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 w-12">
                #
              </th>
              ...
              <th className="px-3 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 w-28">
                Age
              </th>
              <th className="px-3 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 w-36">
                Gender
              </th>
              <th className="px-3 py-2 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 w-16">
                Action
              </th>
            </tr>
          </thead>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-3 flex justify-between items-center flex-shrink-0">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
              Ticket Preview ({uploadedFiles.length}{" "}
            ...
            {uploadedFiles.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">
                  Upload ticket files to preview them here
                </p>
              </div>
            ) : (
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          ...
          <div className="flex gap-4">
            <button
              type="button"
              onClick={() =>
                setNewBooking({ ...newBooking, bookingType: "flight" })
              }
              ...
              <input
                ...
                onChange={(e) =>
                  setNewBooking({
                    ...
                    gstNumber: e.target.checked ? newBooking.gstNumber : "",
                  })
                }
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewBooking({ ...newBooking, portal: e.target.value })
                }
              ...
              {errors.portal && (
                <p className="text-red-500 text-sm mt-1">{errors.portal}</p>
              )}
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  />
                  {errors.pnr && (
                    <p className="text-red-500 text-sm mt-1">{errors.pnr}</p>
                  )}
                </div>
                <div></div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <AirportAutocomplete
                    ...
                    onChange={(code) =>
                      setNewBooking({ ...newBooking, sector1: code })
                    }
                    placeholder="Origin..."
                  ...
                  <AirportAutocomplete
                    ...
                    onChange={(code) =>
                      setNewBooking({ ...newBooking, sector2: code })
                    }
                ...
                {(newBooking.ticketType === "Round Trip" ||
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <AirportAutocomplete
                      ...
                      onChange={(code) =>
                        setNewBooking({ ...newBooking, sector3: code })
                      }
                      placeholder={
                        newBooking.ticketType === "Round Trip"
                          ? "Return..."
                    ...
                    {newBooking.ticketType === "Multi City" ? (
                      <AirportAutocomplete
                        ...
                        onChange={(code) =>
                          setNewBooking({ ...newBooking, sector4: code })
                        }
                        placeholder="Final..."
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                ...
                <MT.Input
                  type="number"
                  value={newBooking.netFare}
                  onChange={(e) =>
                    setNewBooking({ ...newBooking, netFare: e.target.value })
                  }
                  onKeyDown={handleNumberInput}
                  min="0"
                  placeholder=""
                ...
                />
                {errors.netFare && (
                  <p className="text-red-500 text-sm mt-1">{errors.netFare}</p>
                )}
              </div>
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium transition-colors"
                  >
                    {showDetailedCharges ? (
                      <>
                        <svg
              ...
              {/* Detailed Charges - Expandable Section */}
              {showDetailedCharges && (
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setShowQuotedDetailedCharges(!showQuotedDetailedCharges)
                    }
                    className="flex items-center gap-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium transition-colors"
                  >
                    {showQuotedDetailedCharges ? (
              ...
              {/* Quoted Detailed Charges - Expandable Section */}
              {showQuotedDetailedCharges && (
                <div className="mb-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                  <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">
                ...
                <div>
                  ...
                  <MT.Input
                    ...
                    onChange={(e) =>
                      setNewBooking({
                        ...newBooking,
                        trainNumber: e.target.value.toUpperCase(),
                      })
                    }
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewBooking({
                        ...newBooking,
                        trainTicketType: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewBooking({ ...newBooking, class: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  >
                ...
                <div>
                  ...
                  <MT.Input
                    ...
                    onChange={(e) =>
                      setNewBooking({
                        ...newBooking,
                        trainFrom: e.target.value.toUpperCase(),
                      })
                    }
                ...
                <div>
                  ...
                  <MT.Input
                    ...
                    onChange={(e) =>
                      setNewBooking({
                        ...newBooking,
                        trainTo: e.target.value.toUpperCase(),
                      })
                    }
